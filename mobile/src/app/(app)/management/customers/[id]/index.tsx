  ...
  const toggleStatus =
    () => {
      ...
      Alert.alert(
        ...
        `Change ${customer.display_name} to ${newStatus}?`,
  ...
  */
  ...
  const deleteCustomer =
    () => {
      ...
      Alert.alert(
        'Delete Customer',
        `Move ${customer.display_name} to the recycle bin?`,
        [
          {
            text: 'Cancel',
            style: 'cancel',
      ...
      >
        ...
        >
          ...
          <Pressable
            ...
            onPress={() =>
              router.push(
                `/(app)/management/customers/${customer.id}/edit` as any
              )
            }
          >
            <Ionicons
