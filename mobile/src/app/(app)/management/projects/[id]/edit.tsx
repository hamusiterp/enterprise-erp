    ...
    async () => {
      ...
      try {
        ...
        */
        ...
        setProjectSource(
          projectData.project_source
        );

        setBidReference(
          projectData.bid_reference ??
          ''
        );
        ...
        setHasSpecifiedArea(
          toYesNo(
            projectData.has_specified_area
          )
        );
        ...
        */
        ...
        setDurationType(
          projectData.duration_type ??
          ''
        );

        setHolidays(
          projectData.no_of_holidays !==
            null &&
          projectData.no_of_holidays !==
            undefined
            ? String(
        ...
        */
        ...
        setHasRetention(
          toYesNo(
            projectData.has_retention
          )
        );

        setRetentionPercent(
          numberString(
            projectData.retention_percent
          )
        );
...
Alert.alert(
  'Project Updated',
  `${updated.project_no} has been updated successfully.`,
  [
    {
      text: 'OK',
      ...
      onPress: () => {
        ...
        router.replace(
          `/(app)/management/projects/${projectId}` as any
        );
...
return (
  ...
  >
    ...
    {/* your existing Edit Project form */}
